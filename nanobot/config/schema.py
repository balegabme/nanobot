...
class ProvidersConfig(BaseModel):
    ...
    opencode: ProviderConfig = Field(default_factory=ProviderConfig)  # OpenCode Zen gateway
    kilocode: ProviderConfig = Field(default_factory=ProviderConfig)  # Kilocode gateway
...
class Config(BaseSettings):
    ...
    def get_extra_headers(self, model: str | None = None) -> dict[str, str] | None:
        """Get extra headers for the given model (e.g. APP-Code for AiHubMix)."""
        p = self.get_provider(model)
