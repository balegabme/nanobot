...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # OpenCode Zen: global gateway, requires User-Agent header for Cloudflare bypass.
    # Uses direct HTTP calls instead of LiteLLM due to header requirements.
    ProviderSpec(
        name="opencode",
        keywords=("opencode",),
        env_key="OPENAI_API_KEY",           # OpenAI-compatible
        display_name="OpenCode Zen",
        litellm_prefix="",                  # Uses direct HTTP, not LiteLLM
        skip_prefixes=(),
        env_extras=(),
        is_gateway=True,
        is_local=False,
        ...
        strip_model_prefix=True,            # opencode/claude-3 → claude-3
        model_overrides=(
            ("kimi-k2.5", {"temperature": 1.0}),
        ),
    ),

    # Kilocode: global gateway, similar to OpenRouter.
    ProviderSpec(
        name="kilocode",
        ...
        is_local=False,
        detect_by_key_prefix="",
        detect_by_base_keyword="kilocode.ai",
        default_api_base="https://kilocode.ai/api/openrouter",
